...
from completion.exceptions import InferenceError, ParseError, ProviderAPIError
from completion.parsers import parse_chat_completions_response
from completion.providers.mistral import MistralProvider
from completion.providers.openai import OpenAIProvider
...
@patch("completion.providers.chat_completions.httpx.post")
