...
from query_sentinel.cli import build_parser, main
from query_sentinel.conf import SETTING_ENABLED, format_settings_help
from query_sentinel.preview import build_kroki_preview_url, load_puml
from query_sentinel.preview_viewer import build_interactive_html
from query_sentinel.readme import load_readme
from query_sentinel.terminal import colorize_help
...
def test_colorize_help_adds_ansi_when_forced(monkeypatch: object) -> None:
    ...
    colored = colorize_help("usage: query-sentinel [-h]\n\noptions:\n  --status")
